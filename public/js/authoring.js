...
function mountMarkdownFormSubmitListener(formElement, editorElement, hiddenInput) {
  formElement.addEventListener('submit', function () {
    var markdown = editorElement.value;
...
(() => {
/*!***********************************!*\
  !*** ./resources/js/authoring.js ***!
  \***********************************/
window.showdown = __webpack_require__(/*! ./showdown.min */ "./resources/js/showdown.min.js");
window.initializeMdEditor = __webpack_require__(/*! ./markdownEditor */ "./resources/js/markdownEditor.js");
})();
